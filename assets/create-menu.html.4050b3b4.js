...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Once, the theme is activated, Location will also be created.</p><p><strong>2. Create a Menu.</strong></p><p>To create Menu, visit this url:</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>&lt;public-url&gt;/backend/cms#/menus/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,12),b=["src"],g=n("ul",null,[n("li",null,"Select Theme"),n("li",null,"Select Location"),n("li",null,"Create Menu Or Select existing Menu")],-1),h=["src"],k=a(`<div class="language-php+HTML line-numbers-mode" data-ext="php+HTML"><pre class="language-php+HTML"><code>{!! vh_location(&#39;top&#39;, true) !!}
