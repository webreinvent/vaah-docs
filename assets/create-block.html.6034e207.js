import{_ as i,r as l,o,c,a as n,d as e,b as p,w as d,e as a}from"./app.62b9cc5c.js";const r={},u=n("h1",{id:"create-block",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#create-block","aria-hidden":"true"},"#"),e(" Create Block")],-1),v=n("hr",null,null,-1),m=a(`<p>For creating block, you need to follow some steps:</p><p><strong>1. Create Location through seeds.</strong></p><p>Create a json file of name <code>theme_locations.json</code> at <code>../&lt;project-name&gt;/VaahCms/Themes/&lt;theme-name&gt;/Database/Seeds/json/</code> this directory.</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">[</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Once, the theme is activated, Location will also be created.</p><p><strong>2. Create a Block.</strong></p><p>To create Block, visit this url:</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>&lt;public-url&gt;/backend/cms#/blocks/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,12),b=["src"],k=n("div",{class:"custom-container warning"},[n("p",{class:"custom-container-title"},"NOTE"),n("ul",null,[n("li",null,"Enter the name"),n("li",null,"Select Theme"),n("li",null,"Select Location"),n("li",null,"Enter Sort in number, this will work when you call blocks by location name."),n("li",null,"Enter content in Editor. You can edit in HTML Editor also."),n("li",null,"Click on Save button.")])],-1),h=["src"],g=a(`<p>Blocks will be fetched on frontend by two Codes:</p><h5 id="by-block-slug" tabindex="-1"><a class="header-anchor" href="#by-block-slug" aria-hidden="true">#</a> By Block slug</h5><div class="language-php+HTML line-numbers-mode" data-ext="php+HTML"><pre class="language-php+HTML"><code>{!! vh_block(&#39;logo&#39;) !!}
