import{_ as i,r as s,o as d,c as a,a as e,b as l,F as u,d as t,e as o}from"./app.d43c1186.js";const r={},c=e("h1",{id:"api",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#api","aria-hidden":"true"},"#"),t(" API")],-1),v=e("p",null,[t("An API-based CMS, also known as a "),e("code",null,"headless CMS"),t(", is a relatively new approach to content management with many advantages, allow you to build websites and apps that are decoupled from their content management tools and integrated via API. This gives you the flexibility to build your front-end using your preferred tools.")],-1),m=e("p",null,"An API-based approach can save a team significant time and money in the initial implementation as well as ongoing maintenance. With an API you have full control of the presentation of your content with your own code.",-1),p=e("h3",{id:"authentication",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#authentication","aria-hidden":"true"},"#"),t(" Authentication")],-1),b=t("VaahCms supports "),q={href:"https://laravel.com/docs/5.8/api-authentication",target:"_blank",rel:"noopener noreferrer"},h=t("API authentication"),g=t(". This allows you to protect the URLs on your web server so that only you can access them. In order to authenticate with HTTP, you may provide a "),x=e("code",null,"API Token",-1),_=t(" with the following URL format:"),f=o(`<div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>&lt;public-url&gt;/api/cms/contents-types?api_token=XXXXXXXXXXXX
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="response-samples-1" tabindex="-1"><a class="header-anchor" href="#response-samples-1" aria-hidden="true">#</a> Response samples</h5><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>{
    &quot;status&quot;: &quot;success&quot;,
    &quot;data&quot;: {
        &quot;id&quot;: 1,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,51);function y(T,P){const n=s("ExternalLinkIcon");return d(),a(u,null,[c,v,m,p,e("p",null,[b,e("a",q,[h,l(n)]),g,x,_]),f],64)}var S=i(r,[["render",y],["__file","api.html.vue"]]);export{S as default};
