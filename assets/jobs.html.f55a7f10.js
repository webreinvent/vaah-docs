import{_ as t,o as p,c as l,a as n,e,d as a}from"./app.62b9cc5c.js";const i={},o=e(`<h1 id="jobs" tabindex="-1"><a class="header-anchor" href="#jobs" aria-hidden="true">#</a> Jobs</h1><h2 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction" aria-hidden="true">#</a> Introduction</h2><p>Through this feature you can monitor the assign jobs. This job section will show you the records of completed jobs only.</p><p>Visit following url you will see the Jobs section:</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>&lt;public-url&gt;/backend#/vaah/advanced/jobs
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Below Image is a example of job records.</p>`,6),c=["src"],u=n("h2",{id:"usage",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#usage","aria-hidden":"true"},"#"),a(" Usage")],-1),d=n("h4",{id:"bulk-delete",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#bulk-delete","aria-hidden":"true"},"#"),a(" Bulk delete")],-1),r=n("p",null,"By selecting datas one can delete the records. Also there is delete all option for make it empty.",-1),k=n("p",null,[n("code",null,"delete by selecting")],-1),v=["src"],m=n("p",null,[n("code",null,"delete all")],-1),b=["src"],h=n("h4",{id:"sorting",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#sorting","aria-hidden":"true"},"#"),a(" Sorting")],-1),g=n("p",null,"You can sort records by ID and with the date it was created.",-1),w=["src"],f=n("h4",{id:"payload",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#payload","aria-hidden":"true"},"#"),a(" Payload")],-1),y=n("p",null,"In payload column there is an eye button present, by clicking it will show the payloads in a popup,",-1),_=["src"],x=e(`<h2 id="how-to-use-job-in-vaahcms" tabindex="-1"><a class="header-anchor" href="#how-to-use-job-in-vaahcms" aria-hidden="true">#</a> How to use job in VaahCMS</h2><h3 id="step-1-configure-the-queue" tabindex="-1"><a class="header-anchor" href="#step-1-configure-the-queue" aria-hidden="true">#</a> Step-1 Configure The Queue</h3><p>Let’s take an example for a better understanding. We will create an email queue using the Laravel Queue and store all the email sending jobs in the database driver.</p><p><code>Command “queue:table” helps you to use the database driver for the queue.</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan queue:table
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Then open the “config/queue.php” file and add below code:</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code>‘<span class="token keyword">default</span>’ <span class="token operator">=&gt;</span> <span class="token function">env</span><span class="token punctuation">(</span>‘<span class="token constant">QUEUE_CONNECTION</span>’<span class="token punctuation">,</span> ‘sync’<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>To create a Queue Job run below command:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan make:job MatchSendEmail
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>In <code>app/Jobs</code> you can see the code like below:</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?PHP</span>
  ...
  <span class="token punctuation">{</span>
   ...
   <span class="token punctuation">}</span>
     ...
     <span class="token punctuation">{</span>
      ...
      <span class="token punctuation">}</span>
 <span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="step-2-create-an-email-template-and-mailable" tabindex="-1"><a class="header-anchor" href="#step-2-create-an-email-template-and-mailable" aria-hidden="true">#</a> Step-2 Create An Email Template And Mailable</h3><p>To create mailable, run below command:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>php artisan make:mail HelloEmail
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>After this command the <code>Mail</code> folder will be created along with the <code>HelloEmail.php</code> file in the <code>app</code> folder. code structure:</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="step-3-testing" tabindex="-1"><a class="header-anchor" href="#step-3-testing" aria-hidden="true">#</a> Step-3 Testing</h3><p>Add the below line in your <code>routes/web.php” file.</code></p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token class-name static-context">Route</span><span class="token operator">::</span><span class="token function">get</span><span class="token punctuation">(</span>‘send<span class="token operator">-</span>test<span class="token operator">-</span>email’<span class="token punctuation">,</span> ‘EmailController@sendEmail’<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Then visit url</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>&lt;project_url&gt;/send-test-email
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>And it will add the job in the “jobs” table.</p>`,32);function Q(s,E){return p(),l("div",null,[o,n("img",{src:s.$withBase("/images/job-1.png")},null,8,c),u,d,r,k,n("img",{src:s.$withBase("/images/job-2.png")},null,8,v),m,n("img",{src:s.$withBase("/images/job-3.png")},null,8,b),h,g,n("img",{src:s.$withBase("/images/job-4.png")},null,8,w),f,y,n("img",{src:s.$withBase("/images/job-5.png")},null,8,_),x])}const j=t(i,[["render",Q],["__file","jobs.html.vue"]]);export{j as default};
