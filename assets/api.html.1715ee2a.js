import{r as a,o as t,c as r,a as e,b as l,F as u,d as n,e as o}from"./app.b0b04a6a.js";import{_ as p}from"./plugin-vue_export-helper.21dcd24c.js";const i={},c=e("h1",{id:"api",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#api","aria-hidden":"true"},"#"),n(" API")],-1),d=e("p",null,[n("An API-based CMS, also known as a "),e("code",null,"headless CMS"),n(", is a relatively new approach to content management with many advantages, allow you to build websites and apps that are decoupled from their content management tools and integrated via API. This gives you the flexibility to build your front-end using your preferred tools.")],-1),b=e("p",null,"An API-based approach can save a team significant time and money in the initial implementation as well as ongoing maintenance. With an API you have full control of the presentation of your content with your own code.",-1),m=e("h3",{id:"authentication",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#authentication","aria-hidden":"true"},"#"),n(" Authentication")],-1),q=n("VaahCms supports "),h={href:"https://laravel.com/docs/5.8/api-authentication",target:"_blank",rel:"noopener noreferrer"},g=n("API authentication"),x=n(". This allows you to protect the URLs on your web server so that only you can access them. In order to authenticate with HTTP, you may provide a "),_=e("code",null,"API Token",-1),f=n(" with the following URL format:"),v=o(`<div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>&lt;public-url&gt;/api/cms/contents-types?api_token=XXXXXXXXXXXX
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>You can ask to Admin for assigning you a <code>API Token</code>.</p><h3 id="content-types" tabindex="-1"><a class="header-anchor" href="#content-types" aria-hidden="true">#</a> Content Types</h3><p>Content Type is the structure or blueprint of a page or a section that your Web Page will display.</p><h4 id="get-a-list-of-content-types" tabindex="-1"><a class="header-anchor" href="#get-a-list-of-content-types" aria-hidden="true">#</a> Get a List of Content Types</h4><p>Get a list of the <code>Content Type</code> objects and their properties in a list. This API retrieves a specific field of <code>Content Types</code>, and returns all the properties of the Content Types with <code>Pagination</code>.</p><h6 id="http-request" tabindex="-1"><a class="header-anchor" href="#http-request" aria-hidden="true">#</a> HTTP request</h6><p><code>GET/POST &lt;public-url&gt;/api/cms/contents-types</code></p><p>This method supports some of the query parameters to help customize the response.</p><table><thead><tr><th>Parameter</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>q</td><td>Value to be search in <code>Name</code>, <code>Slug</code>, <code>Plural Slug</code> and <code>Singular Slug</code> Column</td><td>String</td><td></td></tr><tr><td>per_page</td><td><code>N</code> Item Per Page</td><td>Number</td><td>20</td></tr><tr><td>order</td><td>Sort the results of the list by a given column</td><td>String</td><td>id</td></tr><tr><td>order_by</td><td>Direction of the sort and may be either <code>asc</code> or <code>desc</code></td><td>String</td><td>desc</td></tr><tr><td>filters</td><td>Column name passes as a <code>key</code> and Value passes as a <code>key&#39;s value</code>. Columns: <code>is_published</code>, <code>is_commentable</code></td><td>Array</td><td></td></tr></tbody></table><h5 id="url" tabindex="-1"><a class="header-anchor" href="#url" aria-hidden="true">#</a> URL</h5><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>GET &lt;public-url&gt;/api/cms/contents-types?page=1&amp;per_page=1&amp;
q=pag&amp;order=asc&amp;order_by=updated_at&amp;filters[is_published]=0
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h5 id="request-samples" tabindex="-1"><a class="header-anchor" href="#request-samples" aria-hidden="true">#</a> Request samples</h5><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>POST &lt;public-url&gt;/api/cms/contents-types
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h5 id="response-samples" tabindex="-1"><a class="header-anchor" href="#response-samples" aria-hidden="true">#</a> Response samples</h5><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>{
    &quot;status&quot;: &quot;success&quot;,
    &quot;data&quot;: {
        &quot;current_page&quot;: 1,
        &quot;data&quot;: [
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h5 id="response-samples-2" tabindex="-1"><a class="header-anchor" href="#response-samples-2" aria-hidden="true">#</a> Response samples</h5><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>{
    &quot;status&quot;: &quot;success&quot;,
    &quot;data&quot;: {
        &quot;current_page&quot;: 1,
        &quot;data&quot;: [],
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br></div></div><hr>`,51);function y(T,P){const s=a("ExternalLinkIcon");return t(),r(u,null,[c,d,b,m,e("p",null,[q,e("a",h,[g,l(s)]),x,_,f]),v],64)}var k=p(i,[["render",y]]);export{k as default};
