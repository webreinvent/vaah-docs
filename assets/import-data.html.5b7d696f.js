import{_ as s,o as a,c as e,a as t,F as p,e as o}from"./app.d43c1186.js";const l={},i=o(`<h1 id="import-sample-data" tabindex="-1"><a class="header-anchor" href="#import-sample-data" aria-hidden="true">#</a> Import Sample Data</h1><hr><p>Dummy data is mock data generated at random as a substitute for live data in testing environments. In other words, dummy data acts as a placeholder for live data.</p><p>You can add while doing a fresh setup of Project. For that you just create following seeds.</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>      \u251C\u2500\u2500 BlogTheme
          \u251C\u2500\u2500 Database/
              \u251C\u2500\u2500 Seeds/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,22),c=["src"];function u(n,r){return a(),e(p,null,[i,t("img",{src:n.$withBase("/images/import-data-1.png"),alt:"import-data-1"},null,8,c)],64)}var k=s(l,[["render",u],["__file","import-data.html.vue"]]);export{k as default};
