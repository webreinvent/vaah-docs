import{_ as s,o as a,c as e,a as t,e as p}from"./app.e7504ec9.js";const o={},l=p(`<h1 id="import-sample-data" tabindex="-1"><a class="header-anchor" href="#import-sample-data" aria-hidden="true">#</a> Import Sample Data</h1><hr><p>Dummy data is mock data generated at random as a substitute for live data in testing environments. In other words, dummy data acts as a placeholder for live data.</p><p>You can add while doing a fresh setup of Project. For that you just create following seeds.</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>      ├── BlogTheme
          ├── Database/
              ├── Seeds/
