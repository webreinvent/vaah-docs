<template><div><h1 id="app" tabindex="-1"><a class="header-anchor" href="#app" aria-hidden="true">#</a> App</h1>
<nav class="table-of-contents"><ul><li><router-link to="#base-controller">Base Controller</router-link></li><li><router-link to="#main-function">Main function</router-link></li><li><router-link to="#mateial-app-getmaterialapp">Mateial App GetMaterialApp</router-link></li></ul></nav>
<div class="custom-container warning"><p class="custom-container-title">Dependencies</p>
<ul>
<li><a href="https://pub.dev/packages/get" target="_blank" rel="noopener noreferrer">get: ^4.6.5<ExternalLinkIcon/></a></li>
</ul>
</div>
<h2 id="base-controller" tabindex="-1"><a class="header-anchor" href="#base-controller" aria-hidden="true">#</a> Base Controller</h2>
<ul>
<li>Path: <code v-pre>root/lib/vaahextendflutter/base/base_controller.dart</code></li>
</ul>
<p>Base Controller is used for initializing all core functionalities needed by <code v-pre>vaahextendflutter</code>.</p>
...
<span class="token class-name">Future</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token keyword">void</span><span class="token punctuation">></span></span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">async</span> <span class="token punctuation">{</span>
  ...
  <span class="token class-name">BaseController</span> baseController <span class="token operator">=</span> <span class="token class-name">Get</span><span class="token punctuation">.</span><span class="token function">put</span><span class="token punctuation">(</span><span class="token class-name">BaseController</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token keyword">await</span> baseController<span class="token punctuation">.</span><span class="token function">init</span><span class="token punctuation">(</span>
    app<span class="token punctuation">:</span> <span class="token keyword">const</span> <span class="token class-name">AppConfig</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
    <span class="token comment">// If you have configured firebase correctly for your app, pass firebase options here</span>
  <span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Pass main app as argument in init method</span>
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><br><br><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>More documentation about <RouterLink to="/vaahflutter/core/firebase-setup.html">firebase</RouterLink>.</p>
<h2 id="mateial-app-getmaterialapp" tabindex="-1"><a class="header-anchor" href="#mateial-app-getmaterialapp" aria-hidden="true">#</a> Mateial App GetMaterialApp</h2>
<ul>
<li>
<p>We recommend using, VaahFlutter <code v-pre>EnvironmentConfig</code>, VaahFlutter <code v-pre>AppTheme</code>, VaahFlutter <code v-pre>route middleware</code>, and VaahFlutter <code v-pre>DebugWidget</code>.</p>
</li>
<li>
<p>You can check the documentation here:</p>
<ul>
<li><RouterLink to="/vaahflutter/essentials/environments.html">EnvironmentConfig</RouterLink></li>
<li><RouterLink to="/vaahflutter/directory_structure/vaahextendflutter/apptheme.html">AppTheme</RouterLink></li>
<li><RouterLink to="/vaahflutter/directory_structure/lib/routes/middleware.html">routeMiddleware</RouterLink></li>
<li><RouterLink to="/vaahflutter/directory_structure/vaahextendflutter/widgets/debug.html">DebugWidget</RouterLink></li>
</ul>
</li>
</ul>
...
<span class="token keyword">class</span> <span class="token class-name">AppConfig</span> <span class="token keyword">extends</span> <span class="token class-name">StatelessWidget</span> <span class="token punctuation">{</span>
  <span class="token keyword">const</span> <span class="token class-name">AppConfig</span><span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token keyword">super</span><span class="token punctuation">.</span>key<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>

  <span class="token metadata function">@override</span>
  <span class="token class-name">Widget</span> <span class="token function">build</span><span class="token punctuation">(</span><span class="token class-name">BuildContext</span> context<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token class-name">EnvironmentConfig</span> config <span class="token operator">=</span> <span class="token class-name">EnvironmentConfig</span><span class="token punctuation">.</span><span class="token function">getEnvConfig</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token keyword">return</span> <span class="token class-name">GetMaterialApp</span><span class="token punctuation">(</span>
      title<span class="token punctuation">:</span> config<span class="token punctuation">.</span>appTitle<span class="token punctuation">,</span>
      theme<span class="token punctuation">:</span> <span class="token class-name">ThemeData</span><span class="token punctuation">(</span>
        primarySwatch<span class="token punctuation">:</span> <span class="token class-name">AppTheme</span><span class="token punctuation">.</span>colors<span class="token punctuation">[</span><span class="token string-literal"><span class="token string">'primary'</span></span><span class="token punctuation">]</span><span class="token punctuation">,</span>
      <span class="token punctuation">)</span><span class="token punctuation">,</span>
