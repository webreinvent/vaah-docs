<template><div><h1 id="migrations-and-seeds" tabindex="-1"><a class="header-anchor" href="#migrations-and-seeds" aria-hidden="true">#</a> Migrations and Seeds</h1>
<h5 id="generate-migrations" tabindex="-1"><a class="header-anchor" href="#generate-migrations" aria-hidden="true">#</a> Generate Migrations</h5>
<p>Let's assume there is only one table required for this module which is <code v-pre>art_articles</code>, here <code v-pre>art</code> is prefix for the module, so if you need to create more tables, you should always use prefix for all the tables to determine which table belongs to which module.</p>
<p>To generate migration use following command:</p>
<div class="language-php line-numbers-mode" data-ext="php"><pre v-pre class="language-php"><code>vaah cms<span class="token punctuation">:</span>m<span class="token operator">-</span>make migration Articles art_articles
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>This will generate a migration file at <code v-pre>VaahCms/Modules/Articles/Database/Migrations/</code>. Let's edit the migration file to following:</p>
...
<p>In this tutorial, let's assume that we want to add 15 articles by default whenever the module is activated, hence we'll be editing <code v-pre>DatabaseTableSeeder.php</code> file.</p>
<div class="language-php line-numbers-mode" data-ext="php"><pre v-pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
