...
<p>All of the configuration/Information of Vaahcms's <code v-pre>Modules</code> are stored in the <code v-pre>config.php</code> file, which is in the <code v-pre>VaahCms\Modules\Articles\Config\</code> directory.</p>
