...
<p>At <code v-pre>VaahCms/Themes/BlogTheme/Http/Controllers/Frontend/FrontendController.php</code> file you will find index method and update <code v-pre>blogtheme::frontend.pages.index</code> change in to <code v-pre>blogtheme::frontend.home</code> at <code v-pre>line 18</code> which will display the view from <code v-pre>VaahCms/Themes/BlogTheme//Resources/views/frontend/home.blade.php</code> .</p>
