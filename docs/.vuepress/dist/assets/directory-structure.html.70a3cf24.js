import{_ as d,r as t,o as r,c as l,a as e,b as s,w as a,d as n,e as o}from"./app.4c6f355c.js";const c={},v=e("h1",{id:"directory-structure",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#directory-structure","aria-hidden":"true"},"#"),n(" Directory Structure")],-1),u={class:"table-of-contents"},m=o(`<h2 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction" aria-hidden="true">#</a> Introduction</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>   app/
      bootstrap/
      ├── cache/
      ├── app.php
      ├── environment.php
