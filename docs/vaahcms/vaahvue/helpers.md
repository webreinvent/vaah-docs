...
| ---- | --------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
|      | ajaxGet                     | `url`  `params`  `callback`                                  | The ajaxGet function  enables you to retrieve data from the server. <br><br/>- The url parameter specifies the URL you wish to request.<br/>- The params parameter specifies data you want to send with the request.<br/>- The callback function which is called when the response has been received. |
|      | ajax                        | `url`  `params`  `callback`  `query`                         | The ajax function enables you to post data to the server.<br/><br/>- The url parameter specifies the URL you wish to request.<br/>- The params parameter specifies data you want to send with the request.<br/>- The callback function which is called when the response has been received. |
|      | processResponse             | `response`                                                   | The processResponse function processes the response returned by an Ajax request. The response object can contain either a successful response or a validation error. <br/><br/>-A response parameter specifies a response from an Ajax call to a server. |
|      | processError                | `error`                                                      | The processError function processes any error responses from the ajax response. If the app is in debugging mode, it shows error message toasts. Otherwise, it shows a simple message `something went wrong`. <br/><br/>-A error parameter specifies a error response from an Ajax call to a server. |
...
|      | toastSuccess                | `messages`                                                   | Shows success messages as a toast from an array of messages.<br/><br/>- A message parameter specifies array of mesasges. |
|      | toastErrors                 | `messages`                                                   | Shows error messages as a toast from an array of messages.<br/><br/>- A message parameter specifies array of mesasges. |
...
|      | findAndReplaceString        | `find_string`  `replace_string`  `full_string`               | The findAndReplaceString function replaces a specific sub-string from a given string.<br/><br/>- findString 	 : Sub-string to be find.<br/>- replace_string : String which replaced with find string.<br/>- full_string    : String from which the sub-string find. |
