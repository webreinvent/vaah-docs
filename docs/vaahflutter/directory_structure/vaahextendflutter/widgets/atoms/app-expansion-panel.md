...
<img :src="$withBase('/images/flutter/atom-widgets/expansion_panel.gif')" alt="expansion_panel">

[[toc]]

## How to use?

use AppExpansionPanel with default style header, Note: if you are using default header and not passing heading argument, then heding will be nothing but empty.
