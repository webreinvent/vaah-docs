...
4. Start your android emulator through Android Studio.
5. Open the terminal on VSCode and run the command given below to start debugging your application.
6. When the command asks to select a device, choose the emulator which is running.
7. The application should be running in the emulator device after a while.
