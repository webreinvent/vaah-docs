...
| ------------ | ---- | -------------------------------------------- |
| ID         |      |  This column represents the id associated with this attribute group.          |
| Name         |      |  This column represents the attribute group name.         |
| Attributes         |      | This column represent all the attributes associated to this group in list  .         |
| Updated At   |      |  This field to set the specifications updated at property.   |
| Is Active         |      | This field represent the status of attribute group. whether it is active or not.  |
| Actions         |      | This column provides the necessary action to achieve the desires functionality in crud .  |
