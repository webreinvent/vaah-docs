...
- You need to make sure that project you are going to clone exists in the `xampp > htdocs` directory
::
...
::alert{type="warning"}
NOTE
- Download and install latest XAMPP and APACHE from this link https://www.apachefriends.org/download.html
