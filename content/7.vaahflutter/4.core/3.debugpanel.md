...
When a developer wants to add sections to the debug panel to display custom data that is not already available.
...
For more information about `enviroment configuration` [click here]().
