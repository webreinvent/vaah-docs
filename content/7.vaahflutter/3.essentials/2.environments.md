...
class DatadogConfig {
  ...
  DatadogConfig copyWith({
    ...
    return DatadogConfig(
      ...
      site: site ?? this.site,
      nativeCrashReportEnabled: nativeCrashReportEnabled ?? this.nativeCrashReportEnabled,
      reportFlutterPerformance: reportFlutterPerformance ?? this.reportFlutterPerformance,
      firstPartyHosts: firstPartyHosts ?? this.firstPartyHosts,
      tracesSampleRate: tracesSampleRate ?? this.tracesSampleRate,
    );
  }
}
