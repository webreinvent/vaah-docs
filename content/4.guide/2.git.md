...
### Select the Branch
On the left-hand side, you'll see the branch list. Click on the branch that you want to set as the new upstream branch.
...
push some code to another repository. To do this, I am using the upstream branch.
::
...
After selecting the branch, you'll see a "Set as upstream branch" option. Click on this option.

### Confirmation

GitKraken will ask for confirmation to set the branch as the new upstream. Confirm the action.

### Push to the New Upstream

You may need to push your changes to the new upstream branch, so click the "Push" button in
GitKraken to sync your local changes with the updated upstream branch.
