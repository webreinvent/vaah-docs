...
2. https://api-docs.freewheel.tv/beeswax/docs/api-requests-and-responses  
3. https://medium.com/@bojanmajed/standard-json-api-response-format-c6c1aabcaa6d
4. https://docs.oasis-open.org/odata/odata-json-format/v4.0/errata02/os/odata-json-format-v4.0-errata02-os-complete.html#_Toc403940655
5. https://laravel.com/docs/11.x/validation#validation-error-response-format
