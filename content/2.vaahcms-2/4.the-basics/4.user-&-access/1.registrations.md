...
only few of them will be the verified users. The main purpose of `Registration` method  is to prevent `users` tables from being filled with unnecessary   front-end registrations. 
