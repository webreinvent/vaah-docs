...
first, click on the select user role then click on the Super Administrator and  Administrator. Check the below image.


<img src="/images/users-7.png">

Now click on the user. Impersonation is typically a privileged feature available only to authorized administrators or users with specific roles or permissions.

<img src="/images/users-8.png">

You are impersonate user. You can check user name which is impersonated in the right corner of the screen window and you can check all data and other things of this user. For leave this user click on the leave button.
