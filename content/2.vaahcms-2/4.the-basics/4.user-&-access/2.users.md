...
After completing these steps, you will be able to access the impersonated user's account and perform actions on their behalf. To exit the impersonation mode, simply click on the `Leave` button, as shown in the image below.
