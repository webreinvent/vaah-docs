...
##### Create a User 
To create a user you just need to click on `Create` button present in the top right corner of the `Users` section.

Follow below image for reference:
<img src="http://img-v5.getdemo.dev/screenshot/uEjgNvbdjF.png">

When you click on `Create` button, you will be able to see a form where you need to fill the required fields.   
Follow below image for reference:
