...
## Add jobs in database
To add jobs in database you need to add `database` in `config/queue.php` and `.env` files.
...
This code will add your jobs in database `jobs` table.
