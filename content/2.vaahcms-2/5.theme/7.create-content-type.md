...
After creating a Content Type, you can see a button of `Content Structure` on list page.

<img src="/images/create-content-type-2.png" alt="create-content-type-2">

This will open a content structure page. There are two sections of it:-
