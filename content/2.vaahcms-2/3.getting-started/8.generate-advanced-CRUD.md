...
with two tables 1. tr_blogs  2. tr_categories. For every blog we will need to select its category from the 
dropdown list that category will belong to tr_categories. Here 
...
::alert{type="warning"}
NOTE   
This step is mandatory only if you want to fetch records from more than one table.
::
Update all the relationship between the newly created entity and existing entities.

Follow below image for reference:
<img src="/images/generate-crud-2.png">
