...
1. After this, we need to configure the `wdio.conf.js` file. Open the file and follow the steps mentioned below:
    ...
    5. Add the code mentioned below inside "export const config". This adds `appium` service into your project.
        ...
        ```
2. Now, the configuration is completed. But we still need to do some changes with the test files before we can start running our script. 
...
4. Finally open the file `test.e2e.js` in the directory `test/specs`. Replace the "require" codes with the code snippet below:
    ...
    ```
5. The configuration is now complete. You can start running the test scripts now.
