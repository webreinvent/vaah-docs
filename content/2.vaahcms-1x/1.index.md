...
::alert{type="danger" class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert"}
NOTE   
YOU'RE READING AN OUTDATED DOCUMENTATION.   
Latest documentation of `VaahCMS 2.x` is available at:   
[Checkout VaahCMS 2.x Documentation](https://vaah-docs-fl6j18mko-webreinvent.vercel.app/vaahcms-2)
